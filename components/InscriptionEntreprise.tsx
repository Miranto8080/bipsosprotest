      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12">
        <div className="text-center max-w-md px-6">
          ...
          <p className="text-gray-600">
            Merci ! Nous reviendrons vers vous sous 24 à 48 heures pour valider votre compte.
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50 pt-8 pb-16">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center relative mb-6 my-15">
          <button
            type="button"
            onClick={() => (window.location.href = "/ambassadeur-pro")}
            className="absolute top-1 right-0 text-gray-500 hover:text-gray-700"
          >
            <X className="w-7 h-7" />
          </button>

          <div className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-red-600 border border-red-600 rounded-full bg-red-600/10">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mt-4">
            Rejoignez le programme entreprise
          </h1>
          ...
          <form onSubmit={handleSubmit} className="p-5 md:p-8 space-y-6">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-1">
                  ...
                  <div className="flex gap-6">
                    <label className="flex items-center text-sm">
                      <input type="radio" name="civilite" value="M." checked={formData.civilite === "M."} onChange={handleRadioChange} className="text-red-600" required />
                      <span className="ml-1">M.</span>
                    </label>
                    <label className="flex items-center text-sm">
                      <input type="radio" name="civilite" value="Mme" checked={formData.civilite === "Mme"} onChange={handleRadioChange} className="text-red-600" required />
                ...
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Prénom <span className="text-red-600">*</span></label>
                  <input type="text" name="prenom" value={formData.prenom} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Nom <span className="text-red-600">*</span></label>
                  <input type="text" name="nom" value={formData.nom} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Email pro <span className="text-red-600">*</span></label>
                  <input type="email" name="email" value={formData.email} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Téléphone <span className="text-red-600">*</span></label>
                  <input type="tel" name="telephone" value={formData.telephone} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Fonction <span className="text-red-600">*</span></label>
                  <input type="text" name="fonction" value={formData.fonction} onChange={handleChange} placeholder="Ex: DRH" className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="md:col-span-3 space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Raison sociale <span className="text-red-600">*</span></label>
                  <input type="text" name="raisonSociale" value={formData.raisonSociale} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">SIRET <span className="text-red-600">*</span></label>
                  <input type="text" name="siret" value={formData.siret} onChange={handleChange} maxLength={14} placeholder="14 chiffres" className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Effectif <span className="text-red-600">*</span></label>
                  <select name="effectif" value={formData.effectif} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required>
                    <option value="">Sélectionner</option>
                ...
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Adresse siège <span className="text-red-600">*</span></label>
                  <input type="text" name="adresse" value={formData.adresse} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Code postal <span className="text-red-600">*</span></label>
                  <input type="text" name="codePostal" value={formData.codePostal} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required />
                </div>

                <div className="md:col-span-2 space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Ville <span className="text-red-600">*</span></label>
                  <input type="text" name="ville" value={formData.ville} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required />
                </div>

                <div className="md:col-span-3 space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Type d’activité <span className="text-red-600">*</span></label>
                  <select name="typeActivite" value={formData.typeActivite} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required>
                    <option value="">Sélectionner</option>
                    <option value="agriculture">Agriculture, sylviculture et pêche</option>
                    <option value="industrie-extractive">Industries extractives</option>
                    <option value="industrie-manufacturiere">Industrie manufacturière</option>
                    <option value="energie">Production et distribution d’énergie</option>
                    <option value="eau-dechets">Eau et gestion des déchets</option>
                    <option value="btp">Construction et BTP</option>
                    <option value="commerce">Commerce</option>
                    <option value="transport">Transport et entreposage</option>
                    ...
                    <option value="services-admin">Services administratifs</option>
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900 mb-4">Vos besoins</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Licences estimées <span className="text-red-600">*</span></label>
                  <select name="licencesEstimees" value={formData.licencesEstimees} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required>
                    <option value="">Sélectionner</option>
                ...
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Offre souhaitée <span className="text-red-600">*</span></label>
                  <select name="offreSouhaitee" value={formData.offreSouhaitee} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-red-500 text-sm" required>
                    <option value="">Sélectionner</option>
                    <option value="gardian">Gardian</option>
                    <option value="active">Active Assistance</option>
                    <option value="non-sure">Les deux</option>
              ...
              <div className="pt-4 border-t border-gray-200 space-y-4">
                <div className="flex items-start gap-3 text-sm">
                  <input type="checkbox" id="acceptCGU" name="acceptCGU" checked={formData.acceptCGU} onChange={handleChange} className="w-4 h-4 text-red-600 rounded mt-0.5" required />
                  <label htmlFor="acceptCGU" className="text-gray-700 cursor-pointer"><CGULinks /></label>
                </div>

                <div className="flex items-start gap-3 text-sm">
                  <input type="checkbox" id="acceptNewsletter" name="acceptNewsletter" checked={formData.acceptNewsletter} onChange={handleChange} className="w-4 h-4 text-red-600 rounded mt-0.5" />
