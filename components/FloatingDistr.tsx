  ...
  return (
    ...
    >
      <div className="flex gap-3 flex-wrap justify-center py-4">
        <Link
          href="/inscription/distributeur"
          className="
            w-full md:w-auto
            px-4 md:px-6 py-3
            bg-green-600 text-white font-bold rounded
            transition-all hover:bg-green-700 hover:shadow-lg hover:scale-105
            text-sm text-center break-words
            min-w-0 md:min-w-[200px]
          "
        >
          Créez votre compte et découvrez les offres bipSOS Distributeur
        </Link>
        {/* <Link
            href="/contact"
