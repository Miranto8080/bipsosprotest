  ...
  return (
    ...
    >
      <div className="flex gap-3 flex-wrap justify-center py-4">
        <Link
          href="/ambassadeurs/inscription"
          className="
            w-full md:w-auto
            px-4 md:px-6 py-3
            bg-purple-600 text-white font-bold rounded
            transition-all hover:bg-purple-700 hover:shadow-lg hover:scale-105
            text-sm text-center break-words
            min-w-0 md:min-w-[200px]
          "
        >
          Créez votre compte et découvrez les offres bipSOS Ambassadeur
        </Link>
        {/* <Link
            href="/contact"
