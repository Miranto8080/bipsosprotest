...
export default function InscriptionAmbassPro() {
  const [formData, setFormData] = useState<FormData>({
    civility: "", first_name: "", last_name: "", email: "", phone: "", function: "",
    type_structure: "", company_name: "", siret: "", profesional_number: "",
    address: "", postcode: "", city: "", network_description: "", potential_beneficiaries: "",
    ...
    <div className="min-h-screen bg-gray-50 pt-8 pb-16">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center relative mb-6 my-15">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-pink-600 border border-pink-600 rounded-full bg-pink-600/10">
            <FontAwesomeIcon icon={faCircle} className="text-pink-600 text-[6px]" />
            PRESCRIPTEUR
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-5 md:p-8 space-y-6">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-1">
                  ...
                  <div className="flex gap-6">
                    <label className="flex items-center text-sm"><input type="radio" name="civility" value="M." checked={formData.civility === "M."} onChange={handleRadioChange} className="text-pink-600" required /><span className="ml-1">M.</span></label>
                    <label className="flex items-center text-sm"><input type="radio" name="civility" value="Mme" checked={formData.civility === "Mme"} onChange={handleRadioChange} className="text-pink-600" required /><span className="ml-1">Mme</span></label>
                  </div>
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Prénom <span className="text-red-500">*</span></label>
                  <input type="text" name="first_name" value={formData.first_name} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Nom <span className="text-red-500">*</span></label>
                  <input type="text" name="last_name" value={formData.last_name} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Email <span className="text-red-500">*</span></label>
                  <input type="email" name="email" value={formData.email} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Téléphone <span className="text-red-500">*</span></label>
                  <input type="tel" name="phone" value={formData.phone} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Fonction <span className="text-red-500">*</span></label>
                  <input type="text" name="function" value={formData.function} onChange={handleChange} placeholder="Ex: Président" className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" required />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="md:col-span-3 space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Type de structure <span className="text-red-500">*</span></label>
                  <select name="type_structure" value={formData.type_structure} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" required>
                ...
                <div className="md:col-span-2 space-y-1">
                  ...
                  <input type="text" name="company_name" value={formData.company_name} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">SIRET / RNA</label>
                  <input type="text" name="siret" value={formData.siret} onChange={handleChange} placeholder="Facultatif" className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">N° pro (fac.)</label>
                  <input type="text" name="profesional_number" value={formData.profesional_number} onChange={handleChange} placeholder="Ex: RNA" className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" />
                </div>

                <div className="md:col-span-2 space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Adresse <span className="text-red-500">*</span></label>
                  <input type="text" name="address" value={formData.address} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" required />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Code postal <span className="text-red-500">*</span></label>
                  <input type="text" name="postcode" value={formData.postcode} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" required />
                </div>

                <div className="md:col-span-2 space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Ville <span className="text-red-500">*</span></label>
                  <input type="text" name="city" value={formData.city} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" required />
                </div>
              </div>
            </div>

            <div>
              <h2 className="text-lg font-bold text-gray-900 mb-4">Votre réseau de bénéficiaires</h2>
              <div className="space-y-5">
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Description du réseau <span className="text-red-500">*</span></label>
                  <textarea
                    name="network_description"
                    value={formData.network_description}
                    onChange={handleChange}
                    rows={4}
                    placeholder="Nombre d'adhérents, territoire..."
                    className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm resize-none"
                    required
                  />
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-semibold text-gray-900">Bénéficiaires potentiels <span className="text-red-500">*</span></label>
                  <select name="potential_beneficiaries" value={formData.potential_beneficiaries} onChange={handleChange} className="w-full px-3 py-2.5 border-2 border-gray-200 rounded-lg focus:border-pink-600 text-sm" required>
                    <option value="">Sélectionner</option>
                    {potentialBeneficiariesOptions.map(o => (
            ...
            <div className="pt-4 border-t border-gray-200 space-y-4">
              <div className="flex items-start gap-3 text-sm">
                <input type="checkbox" id="acceptCGU" name="acceptCGU" checked={formData.acceptCGU} onChange={handleChange} className="w-4 h-4 text-pink-600 rounded mt-0.5" required />
                <label htmlFor="acceptCGU" className="text-gray-700 cursor-pointer"><CGULinks /></label>
              </div>

              <div className="flex items-start gap-3 text-sm">
                <input type="checkbox" id="acceptNewsletter" name="acceptNewsletter" checked={formData.acceptNewsletter} onChange={handleChange} className="w-4 h-4 text-pink-600 rounded mt-0.5" />
